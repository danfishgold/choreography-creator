		...
		switch (_p3.ctor) {
			...
			case 'AddClick':
				...
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{clicks: clicks});
				return {ctor: '_Tuple2', _0: model_, _1: command};
			case 'StartOrStop':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _danfishgold$move_juggler$MoveJuggler$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('main-div'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('moves-div'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'flex', _1: '1 1 auto'},
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('BPM: '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
			...
			return A2(
				...
				function (bpm) {
					return A2(
						...
						A2(_elm_lang$core$Json_Decode$field, 'moves', _elm_lang$core$Json_Decode$string));
				},
