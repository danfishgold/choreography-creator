...
var _danfishgold$move_juggler$MoveJuggler$randomMove = function (model) {
	return A2(
		_elm_lang$core$Random$map,
		function (i) {
			return A2(_elm_lang$core$Array$get, i, model.moves);
		},
		A2(
...
var _danfishgold$move_juggler$MoveJuggler$init = function (_p0) {
	...
	return {
		...
		_0: {
			...
			clicks: _elm_lang$core$Native_List.fromArray(
				[]),
			bpm: _p1.bpm,
		...
		_1: _danfishgold$move_juggler$MoveJuggler$save(
			{
				moves: A2(
					_elm_lang$core$String$join,
					', ',
					_elm_lang$core$Array$toList(model.moves)),
				bpm: model.bpm,
		...
		switch (_p3.ctor) {
			...
			case 'BpmButtonClicked':
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_elm_lang$core$Basics$always(_danfishgold$move_juggler$MoveJuggler$Nop),
						_danfishgold$move_juggler$MoveJuggler$AddClick,
						_elm_lang$core$Time$now)
				};
			case 'AddClick':
				var _p5 = _p3._0;
				var clicks = A2(
					...
					function (t) {
						return _elm_lang$core$Native_Utils.cmp(_p5 - t, 2 * _elm_lang$core$Time$second) < 0;
					},
					A2(
						_elm_lang$core$List$take,
						4,
						A2(_elm_lang$core$List_ops['::'], _p5, model.clicks)));
				var clickBpm = A2(
			...
			case 'StartOrStop':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							active: _elm_lang$core$Basics$not(model.active)
						}),
					_1: _elm_lang$core$Basics$not(model.active) ? _danfishgold$move_juggler$MoveJuggler$message(_danfishgold$move_juggler$MoveJuggler$Tick) : _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _danfishgold$move_juggler$MoveJuggler$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('main-div')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('moves-div')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Moves: '),
						A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$min('30'),
								_elm_lang$html$Html_Attributes$max('1024'),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_danfishgold$move_juggler$MoveJuggler$BpmButtonClicked)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Calculate')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$type$('number'),
								_elm_lang$html$Html_Attributes$min('4'),
								_elm_lang$html$Html_Attributes$max('1024'),
								_elm_lang$html$Html_Attributes$step('4'),
								_elm_lang$html$Html_Attributes$value(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_danfishgold$move_juggler$MoveJuggler$StartOrStop)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('move-display')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
...
var _danfishgold$move_juggler$MoveJuggler$main = {
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'beatCount', _elm_lang$core$Json_Decode$int),
		function (beatCount) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'bpm', _elm_lang$core$Json_Decode$int),
				function (bpm) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'moves', _elm_lang$core$Json_Decode$string),
						function (moves) {
							return _elm_lang$core$Json_Decode$succeed(
								{beatCount: beatCount, bpm: bpm, moves: moves});
						});
				});
		})
};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['MoveJuggler'], 'MoveJuggler', typeof _danfishgold$move_juggler$MoveJuggler$main === 'undefined' ? null : _danfishgold$move_juggler$MoveJuggler$main);
